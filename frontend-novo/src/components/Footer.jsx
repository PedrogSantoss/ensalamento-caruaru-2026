  ...
  return (
    <footer className="mt-12 bg-slate-50 dark:bg-[#0d1b2a] border-t border-slate-200 dark:border-white/10 py-12 transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
        ...
        <div className="space-y-3">
          ...
          <div className="space-y-2 text-slate-600 dark:text-slate-400 text-sm">
            ...
            <p><span role="img" aria-label="endereço" className="mr-2">📍</span>{unidade?.endereco || '—'}</p>

            <h4 className="font-semibold mt-2">Atendimento Secretária</h4>
            <p><span role="img" aria-label="telefone" className="mr-2">📞</span>Secretaria: (81) 92004-9659</p>
            <p><span role="img" aria-label="telefone" className="mr-2">📞</span>CRA: 3003-4030</p>
          </div>
        </div>
        ...
        <div className="space-y-3">
          ...
          <div className="space-y-2 text-slate-600 dark:text-slate-400 text-sm">
            <a href="https://minhaagendavirtual.com.br/agendamentos/novo/anhanguera-caruaru?fbclid=PAdGRleAPvUD1leHRuA2FlbQIxMQABpt-XymYj9nszStj1c7FZ-WSAUgxyv1yVoCFXJtDIG2-LIuk6PEbnh9xvpw_aem_QZxefN4jeW750_-Snva1pw&utm_source=ig&utm_medium=social&utm_content=link_in_bio" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 hover:text-orange-500 transition-colors group">
              ...
              <span><span role="img" aria-label="agendar" className="mr-2">📅</span>Agendar com a Direção</span>
            </a>
            ...
            <a href="https://minhaagendavirtual.com.br/agendamentos/novo/anhanguera-caruaru?fbclid=PAdGRleAPvUD1leHRuA2FlbQIxMQABpt-XymYj9nszStj1c7FZ-WSAUgxyv1yVoCFXJtDIG2-LIuk6PEbnh9xvpw_aem_QZxefN4jeW750_-Snva1pw&utm_source=ig&utm_medium=social&utm_content=link_in_bio" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 hover:text-orange-500 transition-colors group">
              ...
              <span><span role="img" aria-label="agendar" className="mr-2">📅</span>Agendar com a Coordenação</span>
            </a>
          </div>
        </div>
        ...
        <div className="space-y-3">
          ...
          <div className="text-slate-600 dark:text-slate-400 text-sm space-y-2">
            <a href="https://teams.microsoft.com/l/meetup-join/19%3ameeting_MjRmOTg0MWMtMWRjNC00MzU3LTk0ZGItNDc4NmQ1ZDE3YTc5%40thread.v2/0?context=%7b%22Tid%22%3a%22a50e7b76-8ea5-492c-bf17-97d652fc3ce9%22%2c%22Oid%22%3a%2276079095-1c24-48b5-8ebc-8bad707c5375%22%7d" target="_blank" rel="noopener noreferrer" className="block text-sm text-slate-600 dark:text-slate-400 hover:text-orange-500 transition-colors"><span role="img" aria-label="estagio" className="mr-2">🎓</span>Reunião de Estágio (todo Sábado) — Acessar reunião</a>
            <a href="mailto:estagioanhangueracaruaru@gmail.com" className="block text-sm text-slate-600 dark:text-slate-400 hover:text-orange-500 transition-colors"><span role="img" aria-label="email" className="mr-2">✉️</span>estagioanhangueracaruaru@gmail.com</a>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 pt-8 border-t border-slate-200 dark:border-white/5 text-center text-slate-500 text-sm">
        © 2026 {unidade?.nome}. Todos os direitos reservados - Programador Pedro Santos.
      </div>
    </footer>
  );
}
